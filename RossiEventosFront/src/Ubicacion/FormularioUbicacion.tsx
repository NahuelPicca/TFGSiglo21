    ...
    const leftToolbarTemplate = () => {
        return (
            <div className="flex flex-wrap gap-2">
                ...
                <Button className="button-secundario-cancelar" label="Borrar" severity="danger" onClick={confirmDeleteSelected} disabled={!selectedUbicaciones || !selectedUbicaciones.length} />
            </div>
        );
    };
