    ...
    <div className="hero-container" id="hero-sec">
      <div className="container-fluid ">
        <div className="row d-flex">
          ...
          <div className="col">
            <div className="px-5 py-5 mt-5 text-center">
              <div className="px-2 py-2 align-middle">
                <h1>Alquiler de accesorios para eventos</h1>
              </div>
              <div className="px-2 py-2">
                <button type="button" className="btn btn-outline-primary">Reservar Ahora</button>
              </div>
            </div>
          </div>
        </div>
