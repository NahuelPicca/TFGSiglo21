...
export default function FormularioTipoProducto() {
    ...
    const leftToolbarTemplate = () => {
        return (
            <div className="flex flex-wrap gap-2">
                ...
                <Button className="button-secundario-cancelar" label="Borrar" severity="danger" onClick={confirmDeleteSelected} disabled={!selectedTiposProductos || !selectedTiposProductos.length} />
            </div>
        );
    };
    ...
    const header = (
        <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
            <h4 className="m-0">Tipos de productos</h4>
