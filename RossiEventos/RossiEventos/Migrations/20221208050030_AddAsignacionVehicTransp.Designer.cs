...
namespace RossiEventos.Migrations
{
    ...
    [Migration("20221208050030_AddAsignacionVehicTransp")]
    partial class AddAsignacionVehicTransp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RossiEventos.Entidades.Titular2", b =>
                {
            ...
            modelBuilder.Entity("RossiEventos.Entidades.Titular2", b =>
                {
                    b.HasOne("RossiEventos.Entidades.Persona", null)
                        .WithOne()
                        .HasForeignKey("RossiEventos.Entidades.Titular2", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
